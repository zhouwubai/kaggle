...
class Dataset(object):
    ...
    def prepare(self, class_map=None):
        ...
        TODO: class map is not supported yet.
              When done, it should handle mapping
    ...
    def get_source_class_id(self, class_id, source):
        """Map an internal class ID to the corresponding class ID
    ...
    def source_image_link(self, image_id):
        ...
        Override this to return a URL to the image
        if it's availble online for easy debugging.
        """
...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    # Note that some boxes might be all zeros
...
def data_generator(dataset, config, shuffle=True,
    ...
    while True:
        try:
            ...
            # RPN Targets
            rpn_match, rpn_bbox = nn.build_rpn_targets(
            ...
            if b >= batch_size:
                ...
                if random_rois:
                    ...
                    if detection_targets:
                        ...
                        # Keras requires that output and targets
