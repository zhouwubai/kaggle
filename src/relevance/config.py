import os
import numpy as np
from share.base_config import BaseConfig
...
class ParamConfig(BaseConfig):
    def __init__(self,
        ...
        # path
        self.data_folder = ROOT + "data/relevance"
        ...
        self.processed_train_data_path =\
            "%s/train.processed.csv.pkl" % self.feat_folder
        self.processed_test_data_path =\
            "%s/test.processed.csv.pkl" % self.feat_folder
        self.pos_tagged_train_data_path =\
            "%s/train.pos_tagged.csv.pkl" % self.feat_folder
        self.pos_tagged_test_data_path =\
            "%s/test.pos_tagged.csv.pkl" % self.feat_folder
        ...
        self.cooccurrence_word_exclude_stopword =\
            cooccurrence_word_exclude_stopword
...
config = ParamConfig(feat_folder=ROOT + "data/relevance/Feat/solution",
                     drop_html_flag=True,
                     stemmer_type="porter",
                     cooccurrence_word_exclude_stopword=False)
